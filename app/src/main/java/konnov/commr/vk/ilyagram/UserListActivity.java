...
public class UserListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("User feed");
        usersListView = (ListView) findViewById(R.id.listOfUsersListView);
    ...
    private void updateListView(){
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, usersArrayList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 1 && resultCode == RESULT_OK && data != null){
            ...
            try {
                ...
                ByteArrayOutputStream stream = new ByteArrayOutputStream(); //its gonna allow us convert our image into a parse file

                bitmap.compress(Bitmap.CompressFormat.PNG, 100, stream);

                byte[] byteArray = stream.toByteArray(); //our bitmap is converted to a byte array
